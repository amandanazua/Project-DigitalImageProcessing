...
img = cv2.imread('dataset/upn.jpg')
...
cv2.imshow("img_Kmeans", img_Kmeans)
cv2.imshow("inverted_Bilateral", inverted_Bilateral)
cv2.imshow("cartoon_Bilateral", cartoon_Bilateral)
cv2.waitKey(0)
